    ...
    <div class="container">
        <div class="row top-header bg-l-grey align-items-center">
            ...
            <div class="col-2 pr-0 text-right">
                <a href="new-interview.php" class="btn btn-blue add-btn rounded-0">
                            ...
                            <li class="py-3 align-items-center px-3 bdr-btm">
                                <div class="edit-block">
                                    <ul>
                                        ...
                                        <li><a href="edit-interview.php" class="bg-blue"><img src="images/edit-pen.svg" class="w-100"></a></li>
                                    </ul>
                                </div>
                                <a class="media" href="view-interview.php">
