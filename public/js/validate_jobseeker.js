...
function validate_form(theForm){
	...
	if($.inArray(ext, ['doc','docx','pdf','txt','rtf','jpg','jpeg','jpeg','mp4','txt','gif']) == -1) {
...
//Jobseeker Add Reference Starts
$(document).ready(function(){
	
  $("#js_ref_submit").click(function(){	
	  add_js_ref();
  });
  
});
//Jobseeker Add Reference Ends
//Jobseeker Edit Reference Starts
$(document).ready(function(){
	
  $("#js_edit_ref_submit").click(function(){	
	  edit_js_ref();
  });
  
});
//Jobseeker Edit Reference Ends
