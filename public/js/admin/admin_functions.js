...
function load_language_add_form (){
	$('#add_language_form').modal('show');
}
function load_channel_add_form (){
	$('#add_channel_form').modal('show');
}

function load_language_edit_form(id){
	$.getJSON(baseUrl+'admin/languages/get_language_by_id/'+id, function(data) {
			$('#edit_name').val(data.Name);
			$('#edit_abbreviation').val(data.Abbreviation);
			$('#edit_content').val(data.content);
			$('#key_id').val(data.ID);
			$('#edit_language_form').modal('show');
		});	
		
}
function load_channel_edit_form(id){
	$.getJSON(baseUrl+'admin/channels/get_channel_by_id/'+id, function(data) {
			$('#edit_channel').val(data.channel);
			$('#key_id').val(data.ID);
			$('#edit_channel_form').modal('show');
		});	
		
}

function delete_language(id){
	var myurl = baseUrl+'admin/languages/delete/'+id;
...
function delete_channel(id){
	var myurl = baseUrl+'admin/channels/delete/'+id;
	var is_confirm = confirm("Are you sure you want to delete this Channel ?");
	if(is_confirm){
		  $.get(myurl, function (sts) {
			  if(sts=='done')
				  $("#row_"+id).fadeOut();
