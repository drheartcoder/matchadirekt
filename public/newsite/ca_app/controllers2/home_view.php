...
<div class="container">
    ...
    <section id="demos">
     ...
     ?>
            <div class="item">
              <a href="<?php echo base_url('company/'.$row_top_employer->company_slug);?>" title="Jobs in <?php echo $row_top_employer->company_name;?>"><img src="<?php echo base_url('public/uploads/employer/'.$company_image_name);?>" alt="<?php echo base_url('company/'.$row_top_employer->company_slug);?>" /></a>
            </div>
          <?php
          endforeach;
      endif;
...
<div class="container">
      <div class="col-md-8">
          <div class="titlebar">           
              ...
              <strong> <?php echo count($latest_jobs_result)?> Job(s) of <?=$total_posted_jobs;?></strong>
    ...
    ?>
            <li class="col-md-12" style="margin-bottom: -30px;">
              <div class="intlist">
                ...
                <div class="col-xs-2"> <a href="<?php echo base_url('jobs/'.$row_latest_jobs->job_slug.'?apply=yes');?>" class="applybtn" style="max-height: 31px;" title="<?php echo $row_latest_jobs->industry_name.' Job in '.$row_latest_jobs->city;?>">Apply Now</a> </div>
                <div class="clear"></div>
              </div>
            </li>
            <?php
