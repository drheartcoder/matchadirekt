    ...
    <form name="forgot_form" id="forgot_form" action="" method="post">
      <div class="loginbox">
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            <input type="text" name="captcha" id="captcha" class="form-control" placeholder="<?=lang('Verification Code')?>" />
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-3"></div>
          <div class="col-md-9"><?=lang('Already a member')?>? <a href="<?php echo base_url('login');?>"><?=lang('Click Here')?></a></div>
        </div>
      </div>
    </form>
    <!--/Login-->
      ...
      <div class="signupbox">
        ...
        <a href="<?php echo base_url('jobseeker-signup');?>" class="btn btn-success"><?=lang('Sign Up Now')?></a>
        <div class="clear"></div>
      </div>
    </div>
    <!--/Signup-->   
