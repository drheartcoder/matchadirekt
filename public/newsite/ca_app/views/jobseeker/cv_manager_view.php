...
<div class="container detailinfo">
  <div class="row">
    ...
    <div class="formwraper">
        <div class="titlehead">
          <div class="row">
            <div class="col-md-9"><b><?=lang('CV Manager')?></b></div>
            <div class="col-md-3 text-right"><a href="javascript:;" class="upload_cv" title="<?=lang('Upload Resume')?>"><?=lang('Upload CV')?></a> <a href="javascript:;" class="upload_cv" class="editlink" title="<?=lang('Upload Resume')?>"><i class="fa fa-plus-square">&nbsp;</i></a></div>
