      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-5 text-right"><a href="<?php echo base_url('jobseeker/cv_manager');?>"><?=lang('CV Manager')?></a> <!--<a href="#">Upload CV</a>--> <a href="<?php echo base_url('jobseeker/cv_builder');?>"><?=lang('CV Builder')?></a></div>
          </div>
        </div>
