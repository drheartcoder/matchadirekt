            ...
            ?>
                <li class="row" id="aplied_<?php echo $row_applied_job->applied_id;?>">
                  <div class="col-md-4"><a href="<?php echo base_url('jobs/'.$row_applied_job->job_slug);?>"><?php echo $row_applied_job->job_title;?></a></div>
                   <div class="col-md-4"><a href="<?php echo base_url('jobs/'.$row_applied_job->job_slug);?>"><?php echo $row_applied_job->company_name;?></a><br/><?php if($row_applied_job->answer!="") echo lang('Your answer').' : ('.$row_applied_job->answer.')';if($row_applied_job->file_name!="" && $row_applied_job->answer!="") echo '<br/>';?>
                    <?php 
