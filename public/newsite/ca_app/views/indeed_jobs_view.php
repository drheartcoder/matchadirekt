      ...
      <div class="col-md-12">
        <form name="iform" id="iform" method="get" accept-charset="utf-8">
          <div class="candidatesection">
              ...
              <div class="row">
                <div class="col-md-4">
                  <input type="text" name="q" id="q" class="form-control" required placeholder="<?=lang('Job title or Skill')?>" value="<?php echo $this->input->get('q');?>" />
                </div>
                <div class="col-md-4">
                  <input type="text" name="l" id="l" class="form-control" required placeholder="<?=lang('city or location')?>" value="<?php echo $this->input->get('l');?>" />
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-1">
              <input type="submit" value="Search" class="btn" title="<?=lang('job search engine')?>" alt="<?=lang('job search engine')?>" />
              <div class="clear"></div>
            </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="intlist">
              ...
              <div class="col-md-10">
                ...
                <div class="col-md-5"> <a href="<?php echo $row['url'];?>" target="_blank" class="applybtn"><?=lang('Apply Now')?></a>
