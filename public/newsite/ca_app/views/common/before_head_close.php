...
<link rel="stylesheet" href="<?php echo base_url('public/slider/assets/owl.carousel.min.css'); ?>">
<link rel="stylesheet" href="<?php echo base_url('public/slider/assets/owl.theme.default.min.css'); ?>">
