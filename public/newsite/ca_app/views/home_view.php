    ...
    ?>
            <li class="col-md-12" style="margin-bottom: -30px;">
              <div class="intlist">
                ...
                <div class="col-xs-2"> <a href="<?php echo base_url('jobs/'.$row_latest_jobs->job_slug.'?apply=yes');?>" class="applybtn" style="max-height: 31px;" title="<?php echo $row_latest_jobs->industry_name.' Job in '.$row_latest_jobs->city;?>"><?=lang('Apply Now')?></a> </div>
                <div class="clear"></div>
              </div>
            </li>
            <?php
