...
<div class="row"> <?php echo form_open_multipart('jobseeker_signup',array('name' => 'seeker_form', 'id' => 'seeker_form', 'onSubmit' => 'return validate_form(this);'));?>
  <div class="col-md-12">
    <p><?=lang('The Job Seeker sign up process takes no more than a couple of minutes after which, you can upload your CV, resume plus covering letter and make it available to employers looking for you. Why not join today? it\'s free and you are only one step away from finding that ideal job!')?></p><br/>
    ...
    <div class="formwraper">
      ...
      <div class="formint">
        ...
        <div class="input-group <?php echo (form_error('pass'))?'has-error':'';?>">
          ...
          <input name="pass" type="password" class="form-control" id="pass" autocomplete="off" placeholder="<?=lang('Password')?>" value="<?php echo set_value('pass'); ?>" maxlength="100">
    ...
    <!--Personal info-->
    <div class="formwraper">
      <div class="titlehead"><?=lang('Personal Information')?></div>
      <div class="formint">
    ...
    <!--Professional info-->
    <div class="formwraper">
      <div class="titlehead"><?=lang('Upload Resume')?></div>
      <div class="formint">
        <div class="input-group <?php echo (form_error('cv_file') || $msg)?'has-error':'';?>">
          <label class="input-group-addon"><?=lang('Upload Resume')?> <span>*</span></label>
        ...
        <div class="formsparator">
          <div class="input-group">
            <label class="input-group-addon"><?=lang('Please enter')?>: <?php echo $cpt_code;?> <?=lang('in the text box below')?>:</label>
