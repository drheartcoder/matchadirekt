  ...
  <div class="row">
    ...
    <div class="pagetitlebar">
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            <div class="col-md-7"><b>My Documents</b></div>
        ...
        <?php endif;?>
              ...
              { 
                ?>
                <a style="font-size: 13px;" href="<?=base_url()?>jobseeker/cv_manager/cv_default/<?=$row_resume->ID?>">Mark as Default</a>
               <?php 
              } 
              else 
              { 
                  echo "<span  style='font-size: 13px;'>Default</span>";
              }
              ?>              
              </div>
