<ul class="featurlist">
      ...
      <li><a href="<?php echo base_url('jobseeker/chat');?>" class="innerfetbox <?php echo is_active_like($this->uri->segment(2),'chat');?>"><i class="fa fa-send"></i> <span>Chat with Employers</span></a></li>

      <li><a href="<?php echo base_url('jobseeker/calendar');?>" class="innerfetbox <?php echo is_active_like($this->uri->segment(2),'calendar');?>"><i class="fa fa-calendar"></i> <span>Calendar</span></a></li>
