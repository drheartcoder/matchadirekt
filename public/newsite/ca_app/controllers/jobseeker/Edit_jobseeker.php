...
class Edit_Jobseeker extends CI_Controller {
	...
	public function summary()
	{
		...
		$this->form_validation->set_rules('content', lang('summary'), 'trim|required');
		if ($this->form_validation->run() === FALSE) {
			echo strip_tags(validation_errors());
			exit;
		}
		...
		$this->session->set_flashdata('msg', '<div class="alert alert-success"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>'.lang('Success').'!</strong>' lang('Professional summary has been updated successfully').'.</div>');
		echo "done";
	}
	...
	public function upload_photo(){
		...
		if (!empty($_FILES['upload_pic']['name'])){
			...
			$this->session->set_flashdata('msg', '<div class="alert alert-success"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>'.lang('Success').'!</strong>'. lang('Photo uploaded successfully').'. </div>');
		}
		redirect(base_url('jobseeker/dashboard'));
	}
