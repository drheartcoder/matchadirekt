...
class Education extends CI_Controller {
	...
	public function add()
	{
		...
		$this->session->set_flashdata('msg', '<div class="alert alert-success"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>'.lang('Success').'!</strong>'. lang('Your eduction has been added successfully').'. </div>');
		echo "done";
	}
	...
	public function edit()
	{
		...
		$this->session->set_flashdata('msg', '<div class="alert alert-success"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>'.lang('Success').'!</strong>' .lang('Your eduction has been updated successfully').'. </div>');
		echo "done";
