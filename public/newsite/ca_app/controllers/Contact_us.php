...
class Contact_us extends CI_Controller {
	...
	public function index()
	{
		...
		$this->form_validation->set_rules('captcha', 'captcha code', 'trim|required|callback_check_captcha');
		...
		$this->session->set_flashdata('success_msg', '<div class="alert alert-success">'. lang('Contact Us form has been submitted successfully.').'</div>');
