...
class Choose_package extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = SITE_NAME.' : '. lang('Choose Package');
		$data['msg']='';
		...
		$this->session->set_flashdata('msg', '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert">&times;</a><strong>'.lang('Success').'!</strong>'.lang('New job has been posted successfully').'.</div>');
