...
class Posted_Jobs extends CI_Controller {
	...
	public function search($search_title='te_', $search_company='co_', $search_city='ct_', $search_featured='fe_', $search_sts='st_'){
		$data['title'] = SITE_NAME.': Manage Posted Jobs';
		$data['msg'] = '';
		$this->form_validation->set_rules('search_title', lang('search title'), 'trim');
		$this->form_validation->set_rules('search_company', lang('search company'), 'trim');	
		$this->form_validation->set_rules('search_city', lang('search city'), 'trim');
		$this->form_validation->set_rules('search_featured', lang('search featured'), 'trim');
		$this->form_validation->set_rules('search_sts', lang('search sts'), 'trim');
