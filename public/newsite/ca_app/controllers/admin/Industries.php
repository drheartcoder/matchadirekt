...
class Industries extends CI_Controller {
	public function index(){
		$data['title'] = SITE_NAME.': '.lang('Industry Management');
		$data['msg'] = '';
	...
	public function add(){
		...
		$this->form_validation->set_rules('industries', lang('Industries'), 'trim|required');
	...
	public function update(){
		...
		$this->form_validation->set_rules('edit_industries', lang('Industries'), 'trim|required');
		$this->form_validation->set_error_delimiters('<span class="err" style="padding-left:2px;">', '</span>');
