...
class Institute extends CI_Controller {
	public function index(){
		$data['title'] = SITE_NAME.': '.lang('Institute Management');
		$data['msg'] = '';
	...
	public function add(){
		...
		$this->form_validation->set_rules('institute', lang('Institute'), 'trim|required');
	...
	public function update(){
		...
		$this->form_validation->set_rules('edit_institute', lang('Institute'), 'trim|required');
		$this->form_validation->set_error_delimiters('<span class="err" style="padding-left:2px;">', '</span>');
