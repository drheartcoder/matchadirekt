...
class Pages extends CI_Controller {
	public function index(){
		$data['title'] = SITE_NAME.': '.lang('Page Management');
		$data['msg'] = '';
	...
	public function add(){
		...
		$data['msg'] = '';
		$data_array = array();
		$this->form_validation->set_rules('pageTitle', lang('Heading'), 'trim|required');
		$this->form_validation->set_rules('pageSlug', lang('Page Slug'), 'trim|required');
		$this->form_validation->set_rules('seoMetaTitle', lang('Meta Title'), 'trim|required|max_length[65]');
		$this->form_validation->set_rules('seoMetaKeyword', lang('Meta Keywords'), 'trim');
		$this->form_validation->set_rules('seoMetaDescription', lang('Meta Description'), 'trim|max_length[150]');	
		$this->form_validation->set_rules('editor1', lang('Page Content'), 'trim|required');
	...
	public function update($id=''){
		...
		if($id==''){
			echo json_encode(array('msg'=>lang('Page ID is missing. Please refresh the page and try again.')));
			exit;
		}
	...
	public function delete($id=''){
		...
		if($id==''){
			echo json_encode(array('msg'=>'Oops! '.lang('page ID is missing. Please refresh the page and try again.')));
			exit;
		}
