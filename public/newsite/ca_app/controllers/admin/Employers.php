...
class Employers extends CI_Controller {
	...
	public function update($id=''){
		...
		$this->form_validation->set_rules('full_name', lang('Full Name'), 'trim|required');
		$this->form_validation->set_rules('email', lan('Email'), 'trim|required|valid_email');
		$this->form_validation->set_rules('password', lang('Password'), 'trim|required');	
		$this->form_validation->set_rules('mobile_phone', lang('Mobile Number'), 'trim|required');
	...
	public function status($id='', $current_staus=''){
		...
		if($current_staus==''){
			echo lang('invalid status value provided.');
			exit;
		}
	...
	public function search(){
		$data['title'] = SITE_NAME.': '.lang('Manage Employers');
		$data['msg'] = '';
		$search_name ='';
		$search_email ='';
		$search_company ='';
		...
		$this->form_validation->set_rules('first_name', lang('first name'), 'trim');
		$this->form_validation->set_rules('email', lang('Email'), 'trim');	
		$this->form_validation->set_rules('company_name', lang('Company Name'), 'trim');
		$this->form_validation->set_rules('city', lang('City'), 'trim');
		$this->form_validation->set_rules('industry_ID', lang('Industry ID'), 'trim');
