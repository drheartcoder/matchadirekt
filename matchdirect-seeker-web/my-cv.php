...
<section class="main-container vheight-100">
    ...
    <div class="col-10 col-lg-8 col-xl-8 mx-auto bg-white">
        ...
        <div class="row">
            <div class="col-12 px-0 user-img text-center">
                <img src="images/user.png" class="w-100">
                <div class="user-info">
                    <h5 class="card-title mb-1 text-white font-semi">Marie Winter</h5>
                    <h6 class="card-subtitle mb-2 text-white">Designer</h6>
                </div>
            </div>
        </div>
        <div class="row mt-1">
                    ...
                    <ul class="list-unstyled mb-0">
                        <li class="media align-items-center mb-1">
                            <div class="media-body">
                                <h6 class="mt-0 mb-0 font-reg"><img src="images/envelope.svg" class="mr-2" alt="img">test@test.com</h6>
                            </div>
                        </li>
                        <li class="media align-items-center mb-1">
                            <div class="media-body">
                                <h6 class="mt-0 mb-0 font-reg"><img src="images/cell-phone.svg" class="mr-2" alt="img">8805699566</h6>
                            </div>
                        </li>
                        <li class="media align-items-center mb-1">
                            <div class="media-body">
                                <h6 class="mt-0 mb-0 font-reg"><img src="images/apply-date.svg" class="mr-2" alt="img">06 May 1991</h6>
                            </div>
                        </li>
                        <li class="media align-items-center mb-1">
                            <div class="media-body">
                                <h6 class="mt-0 mb-0 font-reg"><img src="images/job-location.svg" class="mr-2" alt="img">Kungsgatan 22, 651 08 Karlstad, Sweden</h6>
                            </div>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="card-header py-0 px-3 bg-blue border-0 rounded-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-2 px-0 text-right">
                                <a href="add-decument.php" class="btn btn-blue add-btn rounded-0">
                ...
                <div class="card border-0 details-block">
                    <div class="card-header py-0 px-3 bg-blue border-0 rounded-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-2 px-0 text-right">
                                <a href="edit-about.php" class="btn btn-blue add-btn rounded-0">
                                    <img src="images/plus-white.svg" class="w-100">
                                </a>
                            </div>
                        </div>
                ...
                <div class="card border-0 details-block">
                    <div class="card-header py-0 px-3 bg-blue border-0 rounded-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-2 px-0 text-right">
                                <a href="add-experience.php" class="btn btn-blue add-btn rounded-0">
                                    <img src="images/plus-white.svg" class="w-100">
                                </a>
                            </div>
                        </div>
                            ...
                            <li class="py-3 align-items-center px-3 bdr-btm">
                                <div class="edit-block">
                                    <ul>
                                        ...
                                        <li><a href="edit-certificate.php" class=""><img src="images/edit-pen2.svg" class="w-100"></a></li>
                                    </ul>
                                </div>
                ...
                <div class="card border-0 details-block">
                    <div class="card-header py-0 px-3 bg-blue border-0 rounded-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-2 px-0 text-right">
                                <a href="add-education.php" class="btn btn-blue add-btn rounded-0">
                                    <img src="images/plus-white.svg" class="w-100">
                                </a>
                            </div>
                        </div>
                ...
                <div class="card border-0 details-block">
                    <div class="card-header py-0 px-3 bg-blue border-0 rounded-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-2 px-0 text-right">
                                <a href="add-skills.php" class="btn btn-blue add-btn rounded-0">
                                    <img src="images/plus-white.svg" class="w-100">
                                </a>
                            </div>
                        </div>
