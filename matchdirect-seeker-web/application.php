                            ...
                            <li class="py-3 align-items-center px-3 bdr-btm">
                                ...
                                <div class="media-body">
                                    <div class="row align-items-center">
                                        <div class="col-6 card-title mb-0"><a href="job-provider-company.php">Job Provider</a></div>
                                        <p class="col-6 text-d-grey mb-0">Sep 12, 2019</p>
                                        <div class="col-12 card-title mb-0"><a href="full-post.php" class="text-blue"><small>Looking For Web Designer</small></a></div>
                                    </div>
                                </div>
                            </li>
                            <li class="py-3 align-items-center px-3 bdr-btm">
