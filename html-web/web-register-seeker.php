<?php include 'header.php'; ?>
   ...
   <section class=" bg-blue justify-content-between">
        <div class="container">
              <div class="col-11 col-lg-9 col-xl-7 mx-auto bg-white">
        ...
        <div class="row align-items-center">
            <div class="col-12">
                <h6 class="font-semi mt-3 text-center">Register as</h6>
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel">
                        <form class="row mt-4" action="web-login-with-phone.php">
                            ...
                            <div class="form-group text-center mx-auto  mb-3">
                                <button type="submit" class="btn-comm btn btn-blue">Continue</button>
                            </div>
                        </form>
                    </div>
