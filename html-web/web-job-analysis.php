     ...
     <div class="container">
        ...
        <div class="row top-header bg-l-grey align-items-center">
            ...
            <div class="col-2 pr-0 text-right">
                <a href="web-new-analysis.php" class="btn btn-blue add-btn rounded-0">
                            ...
                            <li class="py-3 align-items-center px-3 bdr-btm">
                                <div class="edit-block">
                                    <ul>
                                        ...
                                        <li><a href="web-edit-analysis.php" class=""><img src="images/edit-pen2.svg" class="w-100"></a></li>
                                    </ul>
                                </div>
                                <a class="media" href="web-view-analysis.php">
                                    <div class="media-body">
                                        <div class="row align-items-center">
                                            <div class="col-6 card-title mb-0">Test Analysis
                                                <p class="last-msg mb-0">Lorem Ipsum</p>
                                            </div>
                                            <p class="col-6 text-d-grey mb-0">Sep 12, 2019</p>
                                        </div>
                                    </div>
                                </a>
                            </li>
