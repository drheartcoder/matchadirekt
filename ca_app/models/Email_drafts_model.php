...
class Email_drafts_model extends CI_Model {
    public function __construct() {
	 ...
	 {		
			...
			$mail->Host = 'mail.bixma.com';

			$mail->Username = 'jobsystem@bixma.com';
			$mail->Password = 'gfg@#34d'; 
			 
			$mail->From = 'jobsystem@bixma.com';
			...
			$config['smtp_host']    = 'mail.bixma.com';
			$config['smtp_user']    = 'jobsystem@bixma.com';
			$config['smtp_pass']    = 'gfg@#34d';
			// $config['smtp_host']    = 'ssl://smtp.mailgun.org';
			// $config['smtp_user']    = 'mailgun@mailgun.bixma.com';
			// $config['smtp_pass']    = 'Ztt433*5gk';
	...
	public function jobseeker_signup($email_body,$row){
		...
		//$email_body=replace_string('{LINK}',base_url().'token/jobseeker/'.$row['verification_code'],$email_body);
		return $email_body;
	}
	...
	public function employer_signup($email_body,$row){
		...
		//$email_body=replace_string('{SITE_URL}',WEBURL.'/login',$email_body);
		return $email_body;
	}
...
<p class="txt">A contact us form has been submitted at matchadirekt.com. Details are given below:</p>
