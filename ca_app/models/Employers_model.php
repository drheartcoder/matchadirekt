...
class Employers_model extends CI_Model {
	...
	public function get_employer_by_id($id) {
        $this->db->select('tbl_employers.*, tbl_companies.ID AS CID,tbl_companies.company_name,tbl_companies.company_email,tbl_companies.ownership_type,tbl_companies.company_ceo,tbl_companies.industry_ID,tbl_companies.ownership_type,tbl_companies.company_description,tbl_companies.company_location,tbl_companies.no_of_offices,tbl_companies.company_website,tbl_companies.no_of_employees, tbl_companies.established_in, tbl_companies.company_logo, tbl_companies.company_folder, tbl_companies.company_type, tbl_companies.company_fax, tbl_companies.latitude, tbl_companies.longitude, tbl_companies.company_slug, tbl_companies.company_phone, tbl_job_industries.industry_name');
        $this->db->from('tbl_employers');
		$this->db->join('tbl_companies', 'tbl_employers.company_ID = tbl_companies.ID', 'inner');
