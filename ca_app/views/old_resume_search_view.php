          ...
          <div class="col-md-12">            
            <?php echo form_open_multipart('resume_search/search',array('name' => 'rsearch', 'id' => 'rsearch'));?>
              ...
              <span class="input-group-btn">
                 <input type="submit" name="resume_submit" class="btn" id="resume_submit" value="<?=lang('Search Job')?>" />
              </span>
              <span class="input-group-btn">
      ...
      <div class="boxwraper">
        <div class="formwraper">
          <div class="titlehead">
            ...
            <div class="col-md-6 text-right"><strong><?=lang('Resume')?> <?php echo $from_record.' - '.$page;?> <?=lang('of')?> <?php echo ($total_rows>20)?'20':$total_rows;?></strong> </div>
          </div>
          </div>
        </div>
          ...
          <div class="col-md-12">
            <div class="intlist">
              ...
              <div class="col-md-10">
                ...
                <div class="col-md-5"> <a href="<?php echo base_url('candidate/'.$encrypt_id);?>" target="_blank" class="applybtn"><?=lang('View Profile')?></a>
                  <div class="date"></div>
                </div>
                <div class="clear"> </div>
              </div>
