<aside class="left-side sidebar-offcanvas"> 
  ...
  <section class="sidebar"> 
    ...
    <ul class="sidebar-menu">
      ...
      <li> <a href="<?php echo base_url('admin/languages');?>"><i class="fa fa-angle-double-right"></i><span>Languages</span> </a> </li>
      ...
      <li> <a href="<?php echo base_url('admin/channels');?>"><i class="fa fa-angle-double-right"></i><span>Manage Channels</span> </a> </li>
      ...
      <li> <a href="<?php echo base_url('admin/tutorials');?>"><i class="fa fa-angle-double-right"></i><span>Tutorials</span> </a> </li>
      ...
      <li> <a href="<?php echo base_url('admin/settings');?>"><i class="fa fa-angle-double-right"></i><span>Settings</span> </a> </li> 
