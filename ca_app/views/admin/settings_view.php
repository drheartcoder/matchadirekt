...
<input class="form-control" name="currency" id="currency" maxlength="3" max="3" required value="<?php echo $row->currency;?>" />
                ...
                <div class="form-group">
                <label>Max upload size in Kb (1Mb = 1024Kb)</label>
           
<input class="form-control" name="upload_limit" id="upload_limit" required value="<?php echo $row->upload_limit;?>" />
                <?php echo form_error('upload_limit'); ?> </div>
