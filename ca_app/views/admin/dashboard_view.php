  ...
  <aside class="right-side"> 
    ...
    <section class="content">
     <table width="100%" border="0" align="left">
              ...
              <tr>
                <td align="center"><a href="<?php echo base_url('admin/stories');?>"><i class="fa awesome_style fa-thumbs-up"></i><br>Success Stories</a></td>
                    ...
                    <td align="center"><a href="<?php echo base_url('admin/ads');?>"><i class="fa awesome_style fa-bullhorn"></i><br>Ads</a></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                   ...
                   Qualification</a></td>
                    <td align="center"><a href="<?php echo base_url('admin/prohibited_keyword');?>"><i class="fa awesome_style fa-tags"></i><br>Manage Prohibited Keywords</a></td>
                  </tr>
                  <tr>
                    <td align="center">&nbsp;</td>
                    <td align="center">&nbsp;</td>
                  ...
                  <tr>
                    <td align="center"><a href="<?php echo base_url('admin/skills');?>"><i class="fa awesome_style fa-tags"></i><br> Manage Skills</a></td>
                    ...
                    <td align="center"><a href="<?php echo base_url('admin/languages');?>"><i class="fa fa-language awesome_style"></i><br>
                      Languages</a></td>
                    <td align="center"><a href="<?php echo base_url('admin/settings');?>"><i class="fa fa-gear awesome_style"></i><br>
                      Settings</a></td>
                    <td align="center"></td>
                    <td align="center"></td>
                  </tr>
                  ...
                  <tr>
                    <td align="center"><a href="<?php echo base_url('admin/channels');?>"><i class="fa awesome_style fa-bars"></i><br>Manage Channels</a></td>
                    <td align="center"><a href="<?php echo base_url('admin/tutorials');?>"><i class="fa fa-desktop awesome_style"></i><br>Tutorials</a></td>
