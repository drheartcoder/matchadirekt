                ...
                <div class="box">
                    <form class="mt-4 box-body" action="#" method="post">
                      <!--   <div class="form-group col-12 mb-3">
                        ...
                        <div class="form-group col-12 mb-3">
                            <input type="text" name="txtTutorialName" id="txtTutorialName" class="form-control" value="<?php echo ($tutorialData->tutName); ?>" placeholder="<?=lang('Tutorial Name')?>" required>
                            <span></span>
                        </div>
                        <div class="form-group col-12 mb-3">
                            <div id='edit'>
                        ...
                        <div class="form-group col-12 mb-3">
                            <textarea id="hiddeninput" name="hiddeninput"><?php echo $tutorialData->tutDescrip; ?></textarea> 
                        </div>

                          <div class="col-12 col-lg-9 mx-auto">
                        <div class="row">
                        <div class="form-group col-12 col-sm-6 mb-3">
                          <a href="<?php echo base_url('admin/tutorials');?>" class="btn btn-blue" ><?=lang('Cancel')?></a>   
                        </div>
                        <div class="form-group col-12 col-sm-6  mb-3">
                         
                            <button type="submit" class="btn btn-blue" name="btnUpdateTut" id="btnUpdateTut"><?=lang('Submit')?></button>
                        </div>
                      </div>
                </div>
                    </form>
...
$(document).ready(function () {
  $('#hiddeninput').hide();
  var contents = '<?php echo $tutorialData->tutDescrip; ?>';
  $('#edit').froalaEditor({
  });
...
<script type="text/javascript">
 // $('.fr-element').html('<?php echo $tutorialData->tutDescrip; ?>');
    $(function() {
      $('#edit').froalaEditor({
