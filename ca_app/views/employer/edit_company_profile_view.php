          ...
          <div class="col-md-9">
            <div class="formint">
              ...
              <div class="input-group <?php echo (form_error('industry_id'))?'has-error':'';?>">
                <label class="input-group-addon"><?=lang('Industry')?> <span>*</span></label>
          ...
          <div class="col-md-3 uploadpic" style="padding-top:4px;">
            <div class="picinner">
              ...
              <div class="stripBox ">
                ...
                <a href="javascript:;" onClick="document.location='<?php echo base_url('employer/edit_employer/delete_company_logo');?>'" class="remove" title="<?=lang('Delete Logo')?>"><i class="fa fa-trash-o"></i></a>
                <?php endif;?>
              </div>
            </div>
          </div>
...
</div><div class="modal fade" id="delete_account_modal">
