  ...
  <div class="dashiconwrp">
    ...
    <div class="paginationWrap"> <?php echo ($result_posted_jobs)?$links:'';?> </div>
      ...
      <div class="formwraper">
        <div class="titlehead titlehead_app">
          <div class="row">
         ...
         if($result_posted_jobs):
          foreach($result_posted_jobs as $row_jobs):
            if($row_jobs->sts=="archive")
              goto enddd;
          ?>
          <div class="col-md-12 searchlist_app-p" id="pj_<?php echo $row_jobs->ID;?>">
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-3 pull-right_app-">                
                  <div class="col-md-1 pull-right text-right tools_icon">  
                  <a href="<?php echo base_url('employer/edit_posted_job/'.$row_jobs->ID);?>" title="<?=lang('Edit')?>" class="edit-ico"><i class="fa fa-pencil i_app_style" style="position:relative;top:3px;margin-right:7px;"></i></a>
                </div>
                  <div class="col-md-1 pull-right text-right tools_icon">  
