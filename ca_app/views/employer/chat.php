  ...
  <div class="dashiconwrp">
        ...
        foreach ($convs as $cnv):
          ...
          <li class="clearfix" style="height: 65px;">
              <a href="<?=base_url().'employer/chat/'.$cnv->id_conversation?>" >
                <img style="width: 56px;height: 56px;border-radius: 50%;" class="thumbnail" src="<?php $candidate_logo = ($cnv->photo)?$cnv->photo:'no_pic.jpg'; echo base_url('public/uploads/candidate/'.$candidate_logo);?>" alt="avatar" />
              </a>
                <div class="about">
              <a href="<?=base_url().'employer/chat/'.$cnv->id_conversation?>" >
    ...
    <div class="col-md-9 chat">
      <div class="chat-header clearfix">
        <img style="width: 56px;height: 56px;border-radius: 50%;" src="<?php $candidate_logo = ($job_seeker->photo)?$job_seeker->photo:'no_pic.jpg';echo base_url('public/uploads/candidate/'.$candidate_logo);?>" alt="avatar" />
      ...
      <form enctype="multipart/form-data" method="post" action="<?=base_url().'candidate/send_message/'.$this->custom_encryption->encrypt_data($job_seeker->ID)?>">
      <div class="chat-message clearfix">
        ...
        <button href="javascript:;" onclick="$('#upload_file').click();return false;" title="<?=lang('Upload Document')?>" class="btn btn-success"><i class="fa fa-file">&nbsp;</i></button>
