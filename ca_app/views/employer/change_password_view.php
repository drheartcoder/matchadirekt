      ...
      <div class="formwraper">
        ...
        <div class="formint">
          ...
          <div class="input-group <?php echo (form_error('old_password'))?'has-error':'';?>">
            ...
            <input name="old_password" type="password" class="form-control" id="old_password" placeholder="<?=lang('Old Password')?>" value="<?php echo set_value('pass_code'); ?>" maxlength="100">
          ...
          <div class="input-group <?php echo (form_error('new_password'))?'has-error':'';?>">
            ...
            <input name="new_password" type="password" class="form-control" id="new_password" placeholder="<?=lang('New Password')?>" value="<?php echo set_value('pass_code'); ?>" maxlength="100">
          ...
          <div class="input-group <?php echo (form_error('confirm_password'))?'has-error':'';?>">
            ...
            <input name="confirm_password" type="password" class="form-control" id="confirm_password" placeholder="<?=lang('Confirm Password')?>" value="<?php echo set_value('pass_code'); ?>" maxlength="100">
