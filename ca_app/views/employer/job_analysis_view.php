  ...
  <div class="dashiconwrp">
    ...
    <?php echo $this->session->flashdata('msg');?>
      ...
      <div class="formwraper">
        <div class="titlehead">
          <div class="row">
            <div class="col-md-8"><b><?=lang('Job Analysis')?></b></div>
            <div class="col-md-4 text-right"><a href="javascript:;" onclick="$('#add_job_analysis').modal('show')" class="upload_cv" title="<?=lang('Add Job Analysis')?>"><?=lang('Add Job Analysis')?></a> <a href="javascript:;" class="upload_cv" title="<?=lang('Add Job Analysis')?>"><i class="fa fa-plus-square">&nbsp;</i></a></div>
          </div>
        </div>
        <div class="modal fade" id="add_job_analysis">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                  <h4 class="modal-title"><?=lang('Add Job Analysis')?></h4>
                </div>
                <form action="<?=base_url()?>employer/job_analysis/add" method="post">
              <div class="modal-body" style="min-height: 180px;">
                   ...
                   <div class="col-md-12">
                     <div class="form-group">
                       ...
                       <textarea type="text" id="editor0" name="pageContent" required="required" class="form-control"><?php echo file_get_contents(base_url().'qcsh/default_job_analysis.html');?></textarea>
                     </div>
                   </div>
                </div>
    ...
    <div class="modal fade" id="ifrm_<?=$row->ID?>">
      <div class="modal-dialog">
            ...
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <a style="margin-left: 10px;" href="javascript:;" onclick="$('#update_job_analysis_<?=$row->ID?>').modal('show')" style="text-decoration:none;" title="<?=lang('Edit')?>"><span class="label label-primary"><?=lang('Edit')?></span></a> </div>
        ...
        <div class="modal fade" id="update_job_analysis_<?=$row->ID?>"> 
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                  <h4 class="modal-title"><?=lang('Update Job Analysis')?></h4>
                </div>
                <form action="<?=base_url()?>employer/job_analysis/update/<?=$row->ID?>" method="post">
                <div class="modal-body" style="min-height: 180px;">
                   <div class="col-md-12">
                     <div class="form-group">
                       <label><?=lang('Title')?></label> 
        ...
        <div class="modal fade" id="delete_label_<?=$row->ID?>">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                  <h4 class="modal-title"><?=lang('Delete Job Analysis')?></h4>
                </div>
                <div class="modal-body" style="min-height: 70px;">
                   <div class="col-md-12">
                     <div class="form-group">
                       <h3><?=lang('Do you wanna really delete this job analysis')?> <b>'<?=$row->pageTitle?>'</b> ?</h3>
                     </div>
                   </div>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-default" data-dismiss="modal" aria-hidden="true"><?=lang('Close')?></button>
                  <button type="button" onclick="location.href='<?=base_url()?>employer/job_analysis/delete/<?=$row->ID?>'" class="btn btn-danger"><?=lang('Delete')?></button>
                </div>
              </div>
            </div>
          </div>
        ...
        ?>
          <div align="center" class="text-red"><?=lang('No Job Analysis found')?>.</div>
        <?php endif;?>
        </div>
        <br/>
      </div>
