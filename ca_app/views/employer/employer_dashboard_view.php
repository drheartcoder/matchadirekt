 ...
 <?php $this->load->view('employer/common/employer_menu');?>
    ...
    <div class="col-md-9">
      <div class="row"> 
        ...
        <div class="col-md-12">
          <div class="userinfoWrp">
            ...
            <a href="javascript:;" class="upload" title="<?=lang('Upload Logo')?>"><i class="fa fa-upload"></i></a>
            <?php if($row->company_logo!=''):?>
            <a href="javascript:;" class="remove" id="remove_logo" title="<?=lang('Delete Logo')?>"><i class="fa fa-trash-o"></i></a>
            <?php endif;?>
            </div>
            </div>
            <div class="col-md-6">
              <h1 class="username"><a href="" target="_blank"><?php echo $row->company_name;?></a></h1>
              <div class="comtxt"><?=lang('Current Openings')?>: <?php echo $total_opened_jobs;?></div>
              <div class="comtxt"><?=lang('Staff Members')?>: <?php echo $row->no_of_employees;?></div>
              <div class="comtxt"><a href="<?php if(strpos($row->company_website,'http') === false) echo 'http://'; echo $row->company_website;?>" rel="nofollow" target="_blank"><?php echo $row->company_website;?></a></div>
            </div>
            <div class="col-md-4">
              ...
              <a href="<?php echo base_url('employer/edit_company');?>" id="edit_company_profileee" class="editLink"><i class="fa fa-pencil">&nbsp;</i> <?=lang('Edit Company Profile')?></a> </div>
            <div class="clear"></div>
          </div>
        </div>
        <div class="clear"></div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            <div class="col-md-9"><b><?=lang('About Company')?></b></div>
            <div class="col-md-3 text-right"><a href="javascript:;" id="edit_company_desc" class="editlink" title="<?=lang('Edit')?>"><i class="fa fa-pencil">&nbsp;</i></a></div>
          </div>
        </div>
      ...
      <div class="innerbox2">
        <div class="titlebar ">
          <div class="row">
            <div class="col-md-9"><b><?=lang('Job Applications Received')?></b></div>
            <div class="col-md-3 text-right"><a class="titlebar_a" href="<?php echo base_url('employer/job_applications');?>"><?=lang('View All')?></a></div>
          </div>
        </div>
      ...
      <div class="innerbox2">
        <div class="titlebar titlebar_app">
            <div class="row">
            <div class="col-md-9"><b><?=lang('Current Jobs in')?> <?php echo $row->company_name;?></b></div>
            <div class="col-md-3 text-right"><a class="titlebar_a" href="<?php echo base_url('employer/post_new_job');?>"><?=lang('Post a New Job')?></a>&nbsp;<a class="titlebar_a" href="<?php echo base_url('employer/my_posted_jobs');?>"><?=lang('View All')?></a></div>
          </div>
        </div>
        ...
        <div class="row searchlist "> 
          ...
          <?php 
				 if($result_posted_jobs):
					...
					?>
          <div class="col-md-12 searchlist_app" id="pj_<?php echo $row_jobs->ID;?>">
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  <div class="col-md-4 pull-right text-right pull-right_app">  
                  <a href="<?php echo base_url('employer/edit_posted_job/'.$row_jobs->ID);?>" title="<?=lang('Edit')?>" class="edit-ico_app">
                <i class="fa fa-pencil i_app_style">&nbsp;</i></a>
                  <?php if($row_jobs->sts=='pending'):?>
                  	<span class="label label-warning span_ac_in"><?=lang('Pending Review')?></span>
                  <?php else:?>
                  <a href="javascript:;" style="text-decoration:none;" id="sts_<?php echo $row_jobs->ID;?>" onClick="update_posted_job_status_employer(<?php echo $row_jobs->ID;?>);" title="<?php echo ($row_jobs->sts=='active')?lang('Deactivate'):lang('Activate');?> <?=lang('This Job')?>"><span class="span_ac_in label label-<?php echo ($row_jobs->sts=='active')?'success':'danger';?>"><?php echo lang($row_jobs->sts);?></span></a> 
                  <?php endif;?>
                  
                  
                  </div>
                  <div class="col-md-9">
                    <div class="date date_app"><?php echo date_formats($row_jobs->dated, 'd M Y');?></div>
                  </div>
                </div>
                <div class="clear"> </div>
