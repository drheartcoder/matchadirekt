      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('employer/job_applications');?>"><?=lang('View All')?></a></div>
          </div>
        </div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('employer/post_new_job');?>"><?=lang('Post a New Job')?></a>&nbsp;<a href="<?php echo base_url('employer/my_posted_jobs');?>"><?=lang('View All')?></a></div>
          </div>
        </div>
