<?php $this->load->view('application_views/common/header_emp'); ?>
  ...
  <?php echo form_open_multipart('app/employer/change_password',array('name' => 'change_password_form', 'id' => 'change_password_form'));?>
    ...
    <?php echo $this->session->flashdata('msg');?>
      <!--Account info-->
          ...
          <div class="ara_row <?php echo (form_error('old_password'))?'has-error':'';?>">
            <input name="old_password" type="password" class="form-control app_input" id="old_password" placeholder="<?=lang('Old Password')?>" value="<?php echo set_value('pass_code'); ?>" maxlength="100">
...
<span style="" class="input_label"><?=lang('New Password')?> <b>*</b></span> 
          <div class="ara_row <?php echo (form_error('new_password'))?'has-error':'';?>">
            <input name="new_password" type="password" class="form-control app_input" id="new_password" placeholder="<?=lang('New Password')?>" value="<?php echo set_value('pass_code'); ?>" maxlength="100">
         ...
         <span style="" class="input_label"><?=lang('Confirm Password')?> <b>*</b></span> 
          <div class="ara_row <?php echo (form_error('confirm_password'))?'has-error':'';?>">
            <input name="confirm_password" type="password" class="form-control app_input" id="confirm_password" placeholder="<?=lang('Confirm Password')?>" value="<?php echo set_value('pass_code'); ?>" maxlength="100">
