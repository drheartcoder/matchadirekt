    ...
    <div class="row">
        ...
        <div class="row top-header bg-l-grey align-items-center">
            ...
            <div class="col-8 text-center">
                <h2 class="mb-0"><?=lang('Certificate List')?></h2>
            </div>
            <div class="col-2 pr-0 text-right">
                <a href="<?php echo WEBURL; ?>/employer/certificate/add-certificate" class="btn btn-blue add-btn rounded-0">
                        ...
                        <ul class="messages-list mb-0">
                            ...
                            <li class="py-3 align-items-center px-3 bdr-btm">
                                <div class="edit-block">
                                    <ul>
                                        <li><a href="<?php echo WEBURL; ?>/employer/certificate/delete/<?php echo $cer->ID; ?>" class="bg-red"><img src="<?php echo  $staticUrl;?>/images/close-white.svg" class="w-100"></a></li>
                                        <li><a href="<?php echo WEBURL; ?>/employer/certificate/edit-cetificate/<?php echo $cer->ID; ?>" class="bg-blue"><img src="<?php echo  $staticUrl;?>/images/edit-pen.svg" class="w-100"></a></li>
                                    </ul>
                                </div>
                                <a class="media" href="<?php echo WEBURL; ?>/employer/certificate/view-certificate/<?php echo $cer->ID; ?>">
