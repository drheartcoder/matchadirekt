                                    ...
                                    <li class="py-3 align-items-center px-3 bdr-btm">
                                        <div class="edit-block">
                                            <ul>
                                                ...
                                                <li><a href="<?php echo WEBURL; ?>/employer/job/delete-job/<?php echo $job->ID; ?>" class="bg-red"><img src="<?php echo  $staticUrl; ?>/images/close-white.svg" class="w-100"></a></li>
                                                <li><a href="<?php echo WEBURL; ?>/employer/job/edit/<?php echo $job->ID; ?>" class="bg-blue"><img src="<?php echo  $staticUrl; ?>/images/edit-pen.svg" class="w-100"></a></li>
                                                <?php
                                                  if($job->sts == "inactive")  {
                                                    ?>
                                                    <li><a href="<?php echo WEBURL; ?>/employer/job/change-status/<?php echo $job->ID; ?>" class="bg-success" title="active"><img src="<?php echo  $staticUrl; ?>/images/active.svg" class="w-100"></a></li>
                                                    <?php
                                                  }
                                                ?>
                                                <?php
                                                  if($job->sts == "active"){
                                                    ?>
                                                    <li><a href="<?php echo WEBURL; ?>/employer/job/change-status/<?php echo $job->ID; ?>" class="bg-warning" title="draft"><img src="<?php echo  $staticUrl; ?>/images/draft.svg" class="w-100"></a></li>
                                                    <?php
                                                  }                                                  
                                                ?>
                                        ...
                                        <a class="media" href="<?php echo WEBURL; ?>/employer/job/view-job/<?php echo $job->ID; ?>">
                                        ...
                                        <div class="modal fade" id="add_archive_<?php echo $job->ID;?>">
                                            <div class="modal-dialog">
                                              <div class="modal-content">
                                                ...
                                                <form action="<?=WEBURL?>/employer/labels/label-details-add/<?=$job->ID?>/post_jobs" method="post">
