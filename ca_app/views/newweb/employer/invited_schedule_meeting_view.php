                                ...
                                <div class="media-body">
                                    <div class="row align-items-center">
                                     <div class="col-12 card-title mb-0">
                                        <a href="<?php echo WEBURL; ?>/employer/candidate/candidate-full-post/<?php echo $this->custom_encryption->encrypt_data($candidateDetails->ID); ?>/5/0/<?php echo $employer_id;?>/<?php echo $jobseeker_id;?>">
                                        ...
                                        if(isset($rs) && $rs != "" && isset($rs[0]) && $rs[0] != ""){
                                            ?>
                                            <form action="<?php echo WEBURL; ?>/employer/invitations/update-event" class="col-12" method="POST">
                                                <div class="row">
                                                    <div class="col-12 card-title mb-0"><?=lang('Update Event with')?>  <?php echo $candidateDetails->first_name;?></div>
                                                    <div class="form-group col-12 mb-3">
                                                        <input type="date" class="form-control" placeholder="Date" name="txtDate" id="txtDate" value="<?php echo explode(" ", $rs[0]->date)[0]; ?>" required>
                                                        <span></span>
                                                    </div>
                                                    <div class="form-group col-12 mb-3">
                                                    ...
                                                    <div class="form-group col-12 mb-3">
                                                        <input type="text" class="form-control" placeholder="Notes" name="txtNote" id="txtNote" value="<?php echo $rs[0]->notes; ?>" required>
                                            ...
                                            ?>
                                             <form action="<?php echo WEBURL; ?>/employer/invitations/add-event/<?php echo $candidateDetails->ID; ?>" class="col-12" method="POST">
                                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <a href="<?php echo WEBURL; ?>/employer/candidate/candidate-full-post/<?php echo $this->custom_encryption->encrypt_data($candidateDetails->ID); ?>/5/0/<?php echo $employer_id;?>/<?php echo $jobseeker_id;?>" class="btn btn-blue"><?=lang('Candidate Details')?></a> 
                                            </div>
                                        </div>
