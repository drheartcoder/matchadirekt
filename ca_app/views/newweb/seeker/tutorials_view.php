                        ...
                        <ul class="messages-list mb-0">
                            ...
                            <li class="py-3 align-items-center px-3 bdr-btm">
                                <!-- <div class="edit-block">
                                    <ul>
                                        <li><a href="<?php //echo WEBURL; ?>/seeker/tutorials/tutorial-details/<?php //echo $tdata->ID;?>" class=""><img src="<?php //echo  $staticUrl; ?>/images/close-white2.svg" class="w-100"></a></li>
                                    </ul>
                                </div> -->
                                <a class="media" href="<?php echo WEBURL; ?>/seeker/tutorials/tutorial-details/<?php echo $tdata->ID;?>">
