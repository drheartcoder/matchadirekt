...
<script type="text/javascript">
    $.ajax({
      type: "GET",
      url: "<?php echo WEBURL.'/seeker/home/get_list_of_matching_jobs';?>", 
            ...
            <div class="row top-header bg-l-grey align-items-center">
                ...
                <nav id="main-nav">
                    ...
                    <ul class="second-nav py-4">
                        <li><a href="<?php echo WEBURL; ?>/seeker/home"><img class="mr-3" src="<?php echo  $staticUrl; ?>/images/home.svg">Home</a></li>
                        <li><a href="<?php echo WEBURL; ?>/seeker/job/wishlist-jobs"><img class="mr-3" src="<?php echo  $staticUrl; ?>/images/wishlist.svg">Wishlist</a></li>
                        <li><a href="<?php echo WEBURL; ?>/seeker/my-account"><img class="mr-3" src="<?php echo  $staticUrl; ?>/images/user.svg">Manage Account</a></li>
                        <li><a href="<?php echo WEBURL; ?>/seeker/my-cv"><img class="mr-3" src="<?php echo  $staticUrl; ?>/images/file.svg">My CV</a></li>
                        <li><a href="inbox.php"><img class="mr-3" src="<?php echo  $staticUrl; ?>/images/messenger.svg">Messenger</a></li>
                        <li><a href="<?php echo WEBURL; ?>/seeker/tutorials"><img class="mr-3" src="<?php echo  $staticUrl; ?>/images/tutorial.svg">Employer Showcase</a></li>
                        <li class="notificatin-ic" style="position:relative;"><a href="<?php echo WEBURL; ?>/seeker/notification"><img class="mr-3" src="<?php echo  $staticUrl; ?>/images/bell.svg">Notification<span class="no-ic" style="position: absolute;top:0px; right:0px;background-color: #000; color:#fff; height: 20px; width: 20px; border-radius: 50%">1</span></a></li>
                    </ul>
                    <!-- nav ul list -->
                </nav>
                <!-- nav end -->
                ...
                <div class="col-5 text-right">
                    <ul class="mb-0 notification-list">
                        <li class="d-inline-block mr-3"><a href="<?php echo WEBURL; ?>/seeker/notification"><img src="<?php echo  $staticUrl; ?>/images/bell-menu.svg" class="w-100"></a></li>
                        <li class="d-inline-block mr-3"><a href="<?php echo WEBURL; ?>/seeker/settings/inbox"><img src="<?php echo  $staticUrl; ?>/images/messenger-menu.svg" class="w-100"></a></li>
                        <li class="d-inline-block"><a href="<?php echo WEBURL; ?>/seeker/settings"><img src="<?php echo  $staticUrl; ?>/images/settings.svg" class="w-100"></a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        if(event.direction == "right"){
            ...
            $.ajax({
                  ...
                  success: function(resultData) { 
                        if(resultData === "0") {
                            window.location.href ='<?php echo WEBURL; ?>/seeker/my-account'; 
                        } else {
                            //alert("11");
