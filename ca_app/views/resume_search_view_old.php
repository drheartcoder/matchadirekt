		...
		?>
          <div class="col-md-12 search_resume_app">
            <div class="intlist search_resume_intlist_app">
              <div class="col-md-2"><a href="<?php echo base_url('candidate/'.$encrypt_id);?>" target="_blank" class="thumbnail"><img src="<?php echo base_url('public/uploads/candidate/thumb/'.$candidate_logo);?>" alt="<?php echo $row->first_name;?>" style="max-height:80px;" /></a><div class="col-md-5 search_resume_vp_app"> <a href="<?php echo base_url('candidate/'.$encrypt_id);?>" target="_blank" class="applybtn vp_eye"><?=lang('View Profile')?> &nbsp; <i class="fa fa-arrow-right"></i></a>
                </div></div>
              <div class="col-md-10">
                <div class="col-md-7">
