    ...
    <div class="container">
        <div class="row top-header bg-l-grey align-items-center">
            ...
            <div class="col-8 text-center">
                <h2 class="mb-0">New Interview</h2>
            </div>
        </div>
                ...
                <div class="">
                    <form class="row mt-4" action="#" method="POST">
                        <div class="form-group col-12 mb-3">
                            <input type="text" class="form-control" placeholder="Title" name="pageTitle">
                            <span></span>
                        </div>
                        <div class="form-group col-12 mb-3">
                            <input type="text" class="form-control" placeholder="Slug" name="pageSlug">
                            <span></span>
                        </div>
                        <div class="form-group col-12 mb-3">
                            <div id='edit' name="txtEdit" id="txtEdit"></div>
                        </div>
