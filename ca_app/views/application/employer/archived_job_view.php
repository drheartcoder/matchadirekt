    ...
    <div class="container">
        <div class="row top-header bg-l-grey align-items-center">
            ...
            <div class="col-8 text-center">
                <h2 class="mb-0">Designer Archives</h2>
            </div>
        </div>
        <div class="row">
                            ...
                            <li class="py-3 align-items-center px-3 bdr-btm">
                                <div class="edit-block">
                                    <ul>
                                         ...
                                         <li><a href="<?php echo APPURL; ?>/employer/archives/restore/<?php echo $posted_job->ID; ?>/<?php echo $row->label_id; ?>" class="bg-blue"><img src="<?php echo  $staticUrl; ?>/images/trash-restore.svg" class="w-100"></a></li>
                                        <?php } ?>
                                        <li><a href="<?php echo APPURL; ?>/employer/archives/delete-detail-archive-job/<?php echo $row->ID; ?>" class="bg-red"><img src="<?php echo  $staticUrl; ?>/images/close-white.svg" class="w-100"></a></li>
                                    </ul>
                                </div>
                                <a class="media" href="#view-job">
                                    <div class="media-body">
                                        <div class="row align-items-center">
                                            <div class="col-6 card-title mb-0"><a href="<?php echo APPURL; ?>/employer/job/view-job/<?php echo $posted_job->ID; ?>/2/<?php echo $row->label_id; ?>"><?php echo  $title; ?></a></div>
