    ...
    <div class="container h-100">
        ...
        <div class="row h-100-header align-items-center">
            <div class="col-12 text-center">
              ...
              <h5 class="mb-3"><small><a href="<?php echo  APPURL.'/login/login-with-email'; ?>" class="text-underline">Use a different email</a></small></h5>
              <h5><small><a href="<?php echo  APPURL.'/login/login-with-mobile'; ?>" class="text-underline">Use your phone number</a></small></h5>
            </div>
            <!-- col -->
        </div>
        <!-- row -->
