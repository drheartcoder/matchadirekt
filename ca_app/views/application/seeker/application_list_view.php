                            ...
                            if(isset( $jobData ) &&  $jobData  != ""){
                                ...
                                <li class="py-3 align-items-center px-3 bdr-btm">
                                    <div class="edit-block">
                                        <ul>
                                            <li><a href="<?php echo APPURL; ?>/seeker/my-cv/delete-applied-job/<?php echo $job->applied_id; ?>/1" class="bg-red"><img src="<?php echo  $staticUrl; ?>/images/close-white.svg" class="w-100"></a></li>
                                        </ul>
                                    </div>
                                    <div class="media-body">
                                        <div class="row align-items-center">
                                            <div class="col-6 card-title mb-0"><a href="#<?php echo APPURL; ?>/seeker/company"><?php echo $job->company_name; ?> </a></div>
                                            <p class="col-6 text-d-grey mb-0"><?php echo date("F d,Y",strtotime($job->applied_date)); ?></p>
                                            <div class="col-12 card-title mb-0"><a href="<?php echo APPURL; ?>/seeker/home/job-details/<?php echo $job->job_ID; ?>/1" class="text-blue"><small>Looking For <?php echo  $job->job_title; ?></small></a></div>
                                        </div>
                                    </div>
                                </li>
                                <?php
