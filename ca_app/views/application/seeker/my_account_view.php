        ...
        <div class="row">
            <div class="user-img">
                ...
                <div class="edit-block">
                    <ul>
                        <li><a href="<?php echo APPURL; ?>/seeker/my-account/update-image" class="bg-blue"><img src="<?php echo  $staticUrl; ?>/images/edit-pen.svg" class="w-100"></a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo APPURL; ?>/seeker/my_account/delete-account" class="btn btn-blue">Confirm</a>
            </div>
        </div>
    </div>
</div>
