...
<section>
    <div class="container h-100">
        <div class="row top-header bg-l-grey align-items-center">
            <div class="col-2">
                <a href="<?php echo APPURL; ?>/seeker/settings/notification" class="d-block">
                    ...
                    <div class="card-footer border-0 rounded-0">
                        <div class="input-group mb-0">
                            ...
                            <div class="input-group-append">
                                <button type="button" class="btn send-bgn d-flex" name="btnSend" id="btnSend"><i class="fas fa-paper-plane"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
