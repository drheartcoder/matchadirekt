                ...
                <div class="">
                    <form class="row mt-4" action="#" method="POST">
                        <div class="form-group col-12 skill-block py-3 bg-l-grey">
                            <ul class="skill-group mb-0 <?php if(isset($skillData) && $skillData != ""){ echo 'hasLi'; } ?>" id="olTestList2">
                                <?php  if(isset($skillData) && $skillData != ""){
                                        $i=1;
                                    foreach($skillData as $skill){
                                        ?>
                                    <li class="bg-blue rounded text-white d-inline-block mr-2 skill mb-2" id="<?php echo $i; ?>">
                        ...
                        <div class="form-group col-6 mb-3">
                            <a href="<?php echo APPURL; ?>/seeker/my-cv" class="btn btn-blue" name="btnCancel" id="btnCancel" >Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
