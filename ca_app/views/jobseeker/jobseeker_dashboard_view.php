...
<div class="container detailinfo">
  <div class="row">
    ...
    <div class="pagetitlebar">
                <i class="fa fa-tachometer"></i> <span><?=lang('Dashboard')?></span>
                </div>
      <div class="row"> 
        <!--Company Info-->
        <div class="col-md-12">
          <div class="userinfoWrp">
            ...
            <div class="col-md-4">
              ...
              <a href="<?php echo base_url('jobseeker/my_account');?>" id="edit_jobseeker_profileee" class="editLink"><i class="fa fa-pencil">&nbsp;</i> <?=lang('Edit Profile')?></a> </div>
            <div class="clear"></div>
          </div>
        </div>
        <div class="clear"></div>
...
<div class="innerbox2">
    <div class="titlebar">
      <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="javascript:;" id="add_ref" title="<?=lang('Add Another')?>"><?=lang('Add Another')?></a> <a href="javascript:;" onclick="$('#add_ref').click();" class="editlink" title="<?=lang('Add Another')?>"><i class="fa fa-plus-square">&nbsp;</i></a></div>
      </div>
    </div>
...
<div class="experiance">
   <?php 
    ...
    ?>
        <div class="row expbox" id="exp_<?php echo $row_reference->ID;?>"> 
            <div class="col-md-12">
              <h4><?php echo $row_reference->name;?></h4>
                <ul class="useradon">
                    <li class="company"><b>Title:</b> <?php echo $row_reference->title;?></li>
                    <li><b>Phone:</b> <?php echo $row_reference->phone;?></li>
                    <li><b>Email:</b> <?php echo $row_reference->email;?></li>
                </ul>
                <div class="action"><a href="javascript:;" onClick="load_edit_js_ref(<?php echo $row_reference->ID;?>);" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a> <a href="javascript:;" onClick="del_ref(<?php echo $row_reference->ID;?>);" title="Delete" class="delete-ico"><i class="fa fa-times">&nbsp;</i></a> </div>
            </div>
        </div>
    ...
    <?php endforeach; endif;?>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            <div class="col-md-7"><b><?=lang('My Documents')?></b></div>
            <div class="col-md-5 text-right"><a href="<?php echo base_url('jobseeker/cv_manager');?>"><?=lang('Document Manager')?></a> <!--<a href="#">Upload CV</a>--> <a href="<?php echo base_url('jobseeker/cv_builder');?>"><?=lang('CV Builder')?></a></div>
          </div>
        </div>
      ...
      ?>
            <li class="row" id="cv_<?php echo $row_resume->ID;?>">
              ...
              <?php if($row_resume->is_uploaded_resume): ?>
                <a href="<?php echo base_url('resume/download/'.$row_resume->file_name);?>">Doc N:<?=$i?><br/>
        ...
        <?php endif;?>
              ...
              { 
                ?>
                <a style="font-size: 13px;" href="<?=base_url()?>jobseeker/cv_manager/cv_default/<?=$row_resume->ID?>"><?=lang('Mark as Default')?></a>
               <?php 
              } 
              else 
              { 
                  echo "<span  style='font-size: 13px;'>".lang('Default')."</span>";
              }
              ?>              
              </div>
              <div class="col-md-2 text-right"> <a href="javascript:;" onClick="del_cv(<?php echo $row_resume->ID;?>, '<?php echo $row_resume->file_name;?>')"  title="<?=lang('Delete')?>" class="delete-ico"><i class="fa fa-times">&nbsp;</i></a></div>
            </li>
            <?php   endforeach; 
          else:?>
