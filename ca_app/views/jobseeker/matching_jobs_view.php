  ...
  <div class="row">
    ...
    <div class="col-md-9"><!--Job Detail-->
      ...
      <div class="formwraper">
        <div class="titlehead" style="margin-bottom: 20px!important;">
          <div class="row">
            <div class="col-md-12"><b><?=lang('Matching Jobs')?></b></div>
          </div>
        </div>
        ...
        <div class="err" align="center">
          <p><strong> <?php echo lang('No matching job found').'.';?> </strong></p>
        </div>
        <?php endif;?>
      </div>
      </div>
