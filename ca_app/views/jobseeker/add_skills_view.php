    ...
    <div class="col-md-9"> <?php echo $this->session->flashdata('msg');?>
      ...
      <div class="formwraper">
        ...
        <div class="formint">
          ...
          <?=lang('PHP developer may put following keywords:  PHP developer, PHP coder, PHP programmer, website developer, Word Press, Java Script, JS, Ajax etc.Accountant may enter following:   Accountant, cost accountant, ACCA, Chartered Accountant')?> </p>
