...
<!--Education-->
<div class="vBasicBox">
  <div class="action"> <a href="javascript:;" id="add_education" title="<?=lang('Add Another')?>" class="green-ico"><i class="fa fa-plus-square-o">&nbsp;</i></a> </div>
  <div class="username"><?=lang('EDUCATION AND QUALIFICATION')?></div>
  <ul class="edurowlist">
  <?php 
  ...
  ?>
    <li  id="edu_<?php echo $row_qualification->ID;?>">
      <div class="action"> <a href="javascript:;" onClick="load_edit_js_edu(<?php echo $row_qualification->ID;?>);" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a> <a href="javascript:;" onClick="del_edu(<?php echo $row_qualification->ID;?>);" title="<?=lang('Delete')?>" class="delete-ico"><i class="fa fa-times">&nbsp;</i></a> </div>
...
<!--REFERENCES-->
<div class="vBasicBox">
  <div class="action"> <a href="javascript:;" id="add_ref" title="<?=lang('Add Another')?>" class="green-ico"><i class="fa fa-plus-square-o">&nbsp;</i></a> </div>
  <div class="username"><?=lang('REFERENCES')?></div>
  <ul class="edurowlist">
   <?php 
      if($result_reference):
        foreach($result_reference as $row_reference):
    ?>
    <li id="exp_<?php echo $row_reference->ID;?>">
      ...
      <strong> <?php echo $row_reference->name;?></strong>
      <div class="loctxt">Title: <?php echo $row_reference->title;?></div>
      <div class="txtfont">Phone: <?php echo $row_reference->phone;?></div>
      <div class="txtfont">Email: <?php echo $row_reference->email;?></div>
    </li>
    <?php endforeach; endif;?>
...
<div class="vBasicBox">
  <div class="action"> <a href="javascript:;" id="add_exp" title="<?=lang('Add Another')?>" class="green-ico"><i class="fa fa-plus-square-o">&nbsp;</i></a> </div>
  <div class="username"><?=lang('PROFESSIONAL EXPERIENCE')?></div>
  <ul class="edurowlist">
   <?php 
