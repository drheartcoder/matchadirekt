  ...
  <?php echo form_open_multipart('jobseeker/my_success_story',array('name' => 's_frm', 'id' => 's_frm'));?>
    ...
    <?php echo $this->session->flashdata('msg');?>
      ...
      <div class="formwraper">
        <div class="titlehead"><?=lang('Post Your Success Story')?></div>
        <div class="formint">
          
          <div class="input-group <?php echo (form_error('title'))?'has-error':'';?>">
            <label class="input-group-addon"><?=lang('Title')?> <span>*</span></label>
            <input name="title" type="text" class="form-control" id="title" placeholder="<?=lang('Title')?>" value="<?php echo set_value('title'); ?>" maxlength="100">
            <?php echo form_error('title'); ?>
            </div>
          
          <div class="input-group <?php echo (form_error('story'))?'has-error':'';?>">
            <label class="input-group-addon"><?=lang('Story')?> <span>*</span></label>
