   ...
   <div class="col-md-3"> <div class="dashiconwrp">
    ...
    <?php echo $this->session->flashdata('msg');?>
      ...
      <div class="formwraper">
        <div class="titlehead"><?=lang('Additional Information')?></div>
        <div class="formint">
         <div class="input-group <?php echo (form_error('description'))?'has-error':'';?>">
            <label class="input-group-addon"><?=lang('Career Objective')?> <span>*</span></label>
          ...
          <div class="input-group <?php echo (form_error('awards'))?'has-error':'';?>">
            <label class="input-group-addon"><?=lang('Achievements')?> <span>*</span></label>
            <textarea name="awards" id="awards" class="form-control" rows="4"><?php echo @$row->awards; ?></textarea>
            <?php echo form_error('awards'); ?> </div>
          <div align="center">
            <input type="submit" name="js_additional_submit" id="js_additional_submit" value="<?=lang('Update')?>" class="btn btn-success" />
          </div>
        </div>
      </div>
    </div>
