  ...
  <div class="dashiconwrp">
        ...
        foreach ($convs as $cnv):
          ...
          <li class="clearfix" style="height: 65px;">
              <a href="<?=base_url().'employer/chat/'.$cnv->id_conversation?>" >
                <img style="width: 56px;height: 56px;border-radius: 50%;" class="thumbnail" src="<?php $candidate_logo = ($cnv->company_logo)?$cnv->company_logo:'no_pic.jpg'; echo base_url('public/uploads/employer/'.$candidate_logo);?>" alt="avatar" />
              </a>
                <div class="about">
    ...
    <div class="col-md-9 chat">
      <div class="chat-header clearfix">
        <img style="width: 56px;height: 56px;border-radius: 50%;" src="<?php $candidate_logo = ($employer->company_logo)?$employer->company_logo:'no_pic.jpg'; echo base_url('public/uploads/employer/'.$candidate_logo);?>" alt="avatar" />
        
        <div class="chat-about">
          <div class="chat-with"><?=lang('Chat with')?> <a href="<?=base_url().'company/'.$employer->company_slug?>"><?=$employer->first_name?></a></div>
              ...
              if($msg->type_sender!="employers")
              {
                  ...
                  <li class="clearfix">
                      <div class="message-data align-right">
                        ...
                        <span class="message-data-name" ><?=lang('Me')?></span> <i class="fa fa-circle me"></i>
      ...
      <form enctype="multipart/form-data" method="post" action="<?=base_url().'jobseeker/chat/send_message/'.$this->custom_encryption->encrypt_data($employer->ID)?>">
      <div class="chat-message clearfix">
        ...
        <button href="javascript:;" onclick="$('#upload_file').click();return false;" title="<?=lang('Upload File')?>" class="btn btn-success"><i class="fa fa-file">&nbsp;</i></button>
...
<script type="text/javascript">
  ...
  function showMe(lnkname,lkn)
  {
    if(lkn!="")
    {
       $("#iframe").attr("src", lkn);
       $('#title_link').text(lnkname);
       $('#ifrm').modal('show');
    }
  }
