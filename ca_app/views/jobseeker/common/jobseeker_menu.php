<ul class="featurlist">
      ...
      <li><a href="<?php echo base_url('jobseeker/my_requests');?>" class="innerfetbox <?php echo is_active_like($this->uri->segment(2),'my_requests');?>"><i class="fa fa-lock"></i> <span><?=lang('My Requests')?></span></a></li>
