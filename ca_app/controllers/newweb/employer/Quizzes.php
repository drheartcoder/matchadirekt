...
class Quizzes extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('newweb/employer/quizzes_view',$this->outputData);
	}
	...
	public function add_quizzes(){
		...
		if($title=="" || $quizz=="" || $answer1=="" || $answer2=="" || $answer3=="")
			redirect(WEBURL.'/employer/quizzes');
		...
		$this->load->view('newweb/employer/add_quizzes_view',$this->outputData);
	}
	...
	public function edit_quizzes($id=0){
		...
		$this->load->view('newweb/employer/edit_quizzes_view',$this->outputData);
	}
