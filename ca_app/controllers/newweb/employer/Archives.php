...
class Archives extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('newweb/employer/archives_list_view',$this->outputData);
	}
	...
	public function add_archives(){
		if(isset($_POST['btnSubmit'])){
			...
			redirect(WEBURL."/employer/archives");
		}

		$this->load->view('newweb/employer/add_archievs_view',$this->outputData);
	}
	...
	public function edit($id = 0){
		...
		$this->load->view('newweb/employer/edit_archives_view',$this->outputData);
	}
	...
	public function archived_job($id = 0){
		...
		$this->load->view('newweb/employer/archived_job_view',$this->outputData);
	}
	...
	{	
		...
		// exit;
		redirect(WEBURL.'/employer/archives/archived-job/'.$archiveId);
	...
	public function delete_detail_archive_job($id= 0){
		...
		redirect(WEBURL.'/employer/archives/archived-job/'.$results['0']->ID);
	}
