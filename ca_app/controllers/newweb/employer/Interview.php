...
class Interview extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('newweb/employer/interview_view',$this->outputData);
	}
	...
	public function add_new_interview(){
		...
		redirect(WEBURL.'/employer/interview');
		...
		$this->load->view('newweb/employer/add_new_interview');
	...
	$this->load->view('newweb/employer/edit_interview_view',$this->outputData);
	}
	...
	public function view_interview($id){
		...
		$this->outputData['results']=$results[0];
		// /myPrint($results);die;
		$this->load->view('newweb/employer/interview_detail_view',$this->outputData);
