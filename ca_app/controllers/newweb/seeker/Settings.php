...
class Settings extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('newweb/seeker/settings_view',$this->outputData);
	}
	...
	public function show_applications(){
		...
		$result_applied_jobs = $this->My_model->exequery("SELECT tbl_seeker_applied_for_job.ID as applied_id,  tbl_seeker_applied_for_job.job_ID, tbl_seeker_applied_for_job.dated AS applied_date, tbl_post_jobs.job_title, tbl_companies.company_name ,tbl_companies.ID AS company_ID 
		...
		//myPrint($data);die;
		$this->load->view('newweb/seeker/application_list_view',$this->outputData);
	...
	public function request(){
		...
		$this->outputData['data'] = $data;
		$this->load->view('newweb/seeker/request_view',$this->outputData);
	...
	public function request_detail(){
		...
		$this->outputData['data'] = $data;
		$this->load->view('newweb/seeker/request_detail_view',$this->outputData);
