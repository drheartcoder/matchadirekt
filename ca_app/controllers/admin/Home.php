...
class Home extends CI_Controller {
	public function index(){
		...
		if(!$userRow){
			$data['msg'] = lang('Wrong username or password provided');
			$this->load->view('admin/home_view', $data);
			return;
		}
	...
	public function editpassword(){
		...
		$data['msg'] = '';
		$this->form_validation->set_rules('oldpass', lang('Old Password'), 'trim|required');
		$this->form_validation->set_rules('newpass', lang('New password'), 'trim|required|min_length[5]');
		$this->form_validation->set_rules('renewpass', lang('Confirm Password'), 'trim|required|matches[newpass]');
