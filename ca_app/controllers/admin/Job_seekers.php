...
class Job_Seekers extends CI_Controller {
	public function index(){
		$data['title'] = SITE_NAME.': '.lang('Manage Jobseekers');
		$data['msg'] = '';
	...
	public function update($id=''){
		...
		$this->form_validation->set_rules('first_name', lang('First Name'), 'trim|required');
		$this->form_validation->set_rules('email', lang('Email'), 'trim|required|valid_email');
		$this->form_validation->set_rules('password', lang('Password'), 'trim|required|min_length[6]');	
		$this->form_validation->set_rules('mobile', lang('Mobile Number'), 'trim|required|numeric');
		$this->form_validation->set_rules('dob', lang('Date of Birth'), 'trim|required');
		$this->form_validation->set_rules('present_address', lang('Present address'), 'trim|required');
	...
	public function search($search_name='nm_', $search_email='em_', $search_gender='ge_', $search_city='ct_'){
		...
		$data['msg'] = '';
		$this->form_validation->set_rules('search_name', lang('search name'), 'trim');
		$this->form_validation->set_rules('search_email', lang('search email'), 'trim');	
		$this->form_validation->set_rules('search_gender', lang('search gender'), 'trim');
		$this->form_validation->set_rules('search_city', lang('search city'), 'trim');
