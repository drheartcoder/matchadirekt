...
class Countries extends CI_Controller {
	...
	public function add(){
		...
		$this->form_validation->set_rules('country_name', lang('Country Name'), 'trim|required');
		$this->form_validation->set_rules('country_citizen', lang('Nationality'), 'trim|required');
	...
	public function update(){
		...
		$this->form_validation->set_rules('edit_country_name', lang('Country Name'), 'trim|required');
		$this->form_validation->set_rules('edit_country_citizen', lang('Natonality'), 'trim|required');
		$this->form_validation->set_error_delimiters('<span class="err" style="padding-left:2px;">', '</span>');
