...
class additional_info extends CI_Controller {
	...
	public function index()
	{
		...
		$this->form_validation->set_rules('description', lang('career objective'), 'trim|required|strip_all_tags');
		...
		if($row){
			...
			$this->session->set_flashdata('msg', '<div class="alert alert-success"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>'.lang('Success').'!</strong>'. lang('Additional information has been updated successfully').'. </div>');
		}
		else{
