...
class Cv_Builder extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = SITE_NAME.': '.lang('CV Builder');
		...
		$result_reference = $this->db->query("SELECT * FROM tbl_seeker_reference WHERE seeker_ID='".$this->session->userdata('user_id')."' AND deleted='0'")->result();
