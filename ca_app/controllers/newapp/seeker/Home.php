...
class Home extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('application/seeker/job_tiles_view',$data);
	}
	...
	public function job_details($jid = 0, $returnTo = 0){
		$data =array();
		$jobData=$this->db->query("SELECT *,tbl_employers.city AS emp_city,tbl_employers.country AS emp_country,tbl_post_jobs.ID AS JID from tbl_post_jobs
								...
								WHERE tbl_post_jobs.deleted=0 AND tbl_post_jobs.ID = ".$jid)->result();
		...
		//myPrint($data);exit;
		$this->load->view('application/seeker/job_detail_view',$data);
	}
