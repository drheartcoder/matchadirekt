...
class My_cv extends CI_Controller {
	...
	public function index(){
		...
		$this->load->view('application/seeker/my_cv_view',$this->outputData);
	}
	...
	public function edit_about(){
		...
		if(isset($_POST['btnUpdate'])){
			...
			redirect(APPURL.'/seeker/my-cv');
		}

		$this->outputData['additionalData'] = $additionalData;

		$this->load->view('application/seeker/edit_about_view',$this->outputData);
	}
	...
	public function add_experience(){
		...
		if(isset($_POST['btnSubmit'])){
			...
			if ($this->form_validation->run() === FALSE) {
				...
				$this->load->view('application/seeker/add_experience_view',$this->outputData);
				return;
			}
	...
	public function delete_applied_job($id=0, $redirectTo = 0){
		...
		if( $redirectTo ==1){
			redirect(APPURL.'/seeker/settings/show-applications');
		} else {
			redirect(APPURL.'/seeker/my-cv');
		}
	}
	...
	public function add_document(){
		...
		$resumeData = $this->My_model->selTableData('tbl_seeker_resumes',"","seeker_ID = ".$this->sessUserId);
		$this->outputData['resumeData'] = $resumeData;
		$this->load->view('application/seeker/add_document_view',$this->outputData);
	}
	...
	public function add_education(){
		...
		if(isset($_POST['btnSubmit'])){
			...
			if ($this->form_validation->run() === FALSE) {
				$this->load->view('application/seeker/add_education_view',$this->outputData);
				return;
			}
			$edu_array = array(
								'seeker_ID'			=> $this->sessUserId,
	...
	public function add_skills(){
		...
		$skillData = $this->jobseeker_skills_model->get_records_by_seeker_id($this->sessUserId);
		$this->outputData['skillData'] = $skillData;
		$this->load->view('application/seeker/add_skills_view',$this->outputData);
	}
