...
class My_account extends CI_Controller {
	...
	public function index(){
		...
		$data = $this->My_model->getSingleRowData('tbl_job_seekers',"","ID = ".$this->sessUserId);
		$this->outputData['data'] = $data;
		$this->load->view('application/seeker/my_account_view',$this->outputData);
	}
	...
	public function update_image(){
		...
		if(isset($_POST['btnUpdate'])){
			...
			if ($this->upload->do_upload('imageFile')){
				...
				redirect(APPURL.'/seeker/my-account');
			} else{
		...
		$this->outputData['data'] = $data;
		$this->load->view('application/seeker/update_image_view',$this->outputData);
}
