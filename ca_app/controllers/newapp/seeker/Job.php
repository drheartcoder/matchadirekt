...
class Job extends CI_Controller {
	...
	public function wishlist_jobs(){
		...
		$this->load->view('application/seeker/wishlisted_jobs_view',$this->outputData);
	}

	public function remove_wishlist_jobs($id = 0){
		$delete = $this->My_model->del("tbl_seeker_wishlisted_job","ID = ".$id);
		if($delete){
			redirect(APPURL.'/seeker/job/wishlist-jobs');
		}
	}
	...
	public function job_full_post(){
		...
		$this->load->view('application/seeker/job_full_post_view',$this->outputData);
	}
}
