...
class Job_analysis extends CI_Controller {
	...
	public function index(){
		...
		//myPrint($results);die;
		$this->load->view('application/employer/job_analysis_view',$this->outputData);
	}
	...
	public function add_job_analysis(){
			...
			if($pageContent=="" || $pageSlug=="" || $pageTitle=="")
				redirect(APPURL.'/employer/job_analysis');
		...
		$this->load->view('application/employer/add_job_analysis_view',$this->outputData);
	...
	public function edit_job_analysis($id='0'){
		...
		$this->load->view('application/employer/edit_job_analysis_view',$this->outputData);
	}
	public function detail_job_analysis($id='0'){
		...
		//myPrint($results);die;
		$this->load->view('application/employer/job_analysis_detail_view',$this->outputData);
	}
