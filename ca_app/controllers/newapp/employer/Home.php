...
class Home extends CI_Controller {
	...
	public function index(){
		...
		$companyData = $this->My_model->getSingleRowData("tbl_companies","tbl_companies.company_name,tbl_companies.industry_ID,(select industry_name from tbl_job_industries where tbl_job_industries.ID = tbl_companies.industry_ID) industry","tbl_companies.ID =".$this->sessCompanyId);
