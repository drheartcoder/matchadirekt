...
class Edit_Personal_Profile extends CI_Controller {
	...
	public function index()
	{
		...
		$this->session->set_flashdata('msg', '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert">&times;</a><strong>'.lang('Success').'!</strong>'. lang('Your personal information has been updated').'.</div>');
