...
class Jobs extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title_app'] = "Jobs";
		$param = str_replace('-',' ', $this->uri->segment(4));
		$param = strip_tags($param);
		
		$param2 = str_replace('-',' ', $this->uri->segment(5));
		...
		$this->load->view('application_views/jobs_view',$data);
	...
	public function search()
	{
		...
		redirect(base_url('app/jobs/index/'.$param.'/'.$param2),'');
