...
class add_skills extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = $this->session->userdata('first_name').' - ' . lang('Add Skills');
		$data['result'] = $result;
		...
		$data['title_app'] = "Manage Skills";
		
		$this->load->view('application_views/jobseeker/add_skills_view',$data);
		return;
	}
	...
	public function add()
	{
		...
		if($row){
			echo lang("This skill is already added.");
			exit;
		}
