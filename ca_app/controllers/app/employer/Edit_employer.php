...
class Edit_Employer extends CI_Controller {
	...
	public function summary()
	{
		...
		$this->session->set_flashdata('msg', '<div class="alert alert-success"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>'.lang('Success').'!</strong>'. lang('Summary has been updated successfully').' </div>');
		echo "done";
	}
	public function upload_logo(){
		...
		if (!empty($_FILES['upload_logo']['name'])){
			...
			$this->session->set_flashdata('msg', '<div class="alert alert-success"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>'.lang('Success').'!</strong>'.lang('Company logo uploaded successfully').'</div>');
		}
		$redirect = base_url('app/employer/edit_company');
	...
	/*public function delete_company_logo(){
		...
		if(!$this->session->userdata('user_id')){
			$this->session->set_flashdata('msg', '<div class="alert alert-danger"> <a href="#" class="close" data-dismiss="alert">&times;</a> <strong>'.lang('Error').'!</strong>'.lang('Your session has been expired, please re-login first').'. </div>');
