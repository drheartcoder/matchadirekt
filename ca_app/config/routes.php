...
$route['new'] = 'new/home';
$route['newapp'] = 'newapp/login';
$route['newweb'] = 'newweb/welcome';
$route['newweb/lang/(:any)'] 	= 'newweb/Lang/index/$1';
//Frontend
...
$route['ja/(:any)'] = 'content/show_it_ja/$1';
$route['ja_in/(:any)'] = 'content/show_it_ja_in/$1';
...
$route['candidate/Add/(:any)'] = 'candidate/add/$1';
...
$route['employer/download/(:any)'] 	= 'ShowFile/show/$1/1';
$route['employer/my_posted_jobs/(:any)'] 	= 'employer/my_posted_jobs/index/$1';
$route['employer/delete_posted_job/(:num)'] 	= 'employer/my_posted_jobs/delete/$1';
$route['employer/my_archived_jobs'] 	= 'employer/my_posted_jobs/archive';
$route['employer/labels'] 	= 'employer/labels/index';
$route['employer/label_details/(:any)'] 	= 'employer/labels/label_details/$1';
$route['employer/clone/(:any)'] 	= 'employer/edit_posted_job/Clone/$1';
...
$route['employer/statistics/'] 	= 'employer/statistics';
...
$route['jobseeker/show/(:any)'] 	= 'ShowFile/show/$1/1';
$route['resume/show/(:any)'] 	= 'ShowFile/show/$1/2';
$route['file/show/(:any)'] 	= 'ShowFile/show/$1/4';

$route['resume/download/(:any)'] 	= 'ShowFile/show/$1/2';
$route['jobseeker/calendar/'] 	= 'jobseeker/calendar';
$route['chat/download/(:any)'] 	= 'employer/chat/download/$1';
